...
private class ParallelModularBasicInputOutputOptions : OptionGroup(INPUT_OUTPUT_OPTIONS) {
...
private class ParallelModularBasicAutomatonOptions : OptionGroup(AUTOMATON_OPTIONS) {
...
class InferParallelModularBasicCommand :
    AbstractInferParallelModularCommand("modular-parallel-basic") {
    private val io by ParallelModularBasicInputOutputOptions()
    private val params by ParallelModularBasicAutomatonOptions()
