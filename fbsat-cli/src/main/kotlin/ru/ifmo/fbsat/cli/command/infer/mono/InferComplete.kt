...
private class CompleteInputOutputOptions : OptionGroup(INPUT_OUTPUT_OPTIONS) {
...
private class CompleteAutomatonOptions : OptionGroup(AUTOMATON_OPTIONS) {
...
class InferCompleteCommand : AbstractInferMonoCommand("complete") {
    private val io by CompleteInputOutputOptions()
    private val params by CompleteAutomatonOptions()
