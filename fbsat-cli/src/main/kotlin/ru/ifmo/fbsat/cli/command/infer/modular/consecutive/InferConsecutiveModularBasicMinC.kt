...
private class ConsecutiveModularBasicMinCInputOutputOptions : OptionGroup(INPUT_OUTPUT_OPTIONS) {
...
private class ConsecutiveModularBasicMinCAutomatonOptions : OptionGroup(AUTOMATON_OPTIONS) {
...
class InferConsecutiveModularBasicMinCCommand :
    AbstractInferConsecutiveModularCommand("modular-consecutive-basic-minC") {
    private val io by ConsecutiveModularBasicMinCInputOutputOptions()
    private val params by ConsecutiveModularBasicMinCAutomatonOptions()
    ...
    override fun infer(): ConsecutiveModularAutomaton? =
        inferrer.consecutiveModularBasicMinC(
