...
fbSAT is able to use any SAT solver, supporting link:http://www.domagoj-babic.com/uploads/ResearchProjects/Spear/dimacs-cnf.pdf[DIMACS] input.
You can specify it with `--solver <cmd>` flag.

If you already have your favorite SAT solver, use it.
If not, check out link:https://github.com/msoos/cryptominisat[cryptominisat], link:http://www.labri.fr/perso/lsimon/glucose[glucose], link:http://fmv.jku.at/cadical[cadical], link:http://fmv.jku.at/lingeling[lingeling], or any other.
